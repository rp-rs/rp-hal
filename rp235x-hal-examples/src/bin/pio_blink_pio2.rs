//! This example toggles the GPIO25 pin, using a PIO program in the Pio2
//! instance, which is new in the RP235x series.
//!
...
fn main() -> ! {
    ...
    // configure LED pin for Pio2.
    let led: Pin<_, FunctionPio2, _> = pins.gpio25.into_function();
    ...
    let (mut pio, sm0, _, _, _) = pac.PIO2.split(&mut pac.RESETS);
