...
//! [pimoroni_pico_explorer_showcase.rs](https://github.com/rp-rs/pimoroni_pico_explorer/examples/pimoroni_pico_explorer_showcase.rs) for more complete examples
