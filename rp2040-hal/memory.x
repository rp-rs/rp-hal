/*
 * Memory set-up for a generic RP2040 based board.
 *
 * Copyright (c) The RP-RS Developers, 2021
 * Licensed as MIT or Apache 2.0 as per the crate README.md
 *
 * We assume you only have a small flash device fitted. Copy your own memory.x
 * file to the Cargo `OUT_DIR` to override.
 */
